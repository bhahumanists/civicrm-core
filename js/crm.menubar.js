  ...
  CRM.menubar = _.extend({
    ...
    searchTpl:
      '<li id="crm-qsearch" data-name="QuickSearch">' +
        ...
        '</a>' +
        '<ul>' +
        '<li><a href="#" class="crm-quickSearchField"><label><input type="radio" data-tablename="cc" checked="checked" value="cc" name="quickSearchField"> ID/Name/Email/Postcode/Ext</label></a></li>' +
        '<li><a href="#" class="crm-quickSearchField"><label><input type="radio" data-tablename="Group" value="Group" name="quickSearchField"> Civi Group</label></a></li>' +
